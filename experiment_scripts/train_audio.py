...
p.add_argument('--wav_path', type=str, default='../data/pop.00000.wav', help='root for logging')

# General training options
p.add_argument('--batch_size', type=int, default=1)
p.add_argument('--lr', type=float, default=1e-4, help='learning rate. default=5e-5')
p.add_argument('--num_epochs', type=int, default=1000, # 100000
...
training.train(model=model, train_dataloader=dataloader, epochs=opt.num_epochs, lr=opt.lr,
               ...
               model_dir=root_path, loss_fn=loss_fn, summary_fn=summary_fn, type='audio')